...
trait BootHelpers
{
    ...
    {
        return new MiddlewareDeclaration($this->app->make(Router::class), $this->app->make(\Illuminate\Foundation\Http\Kernel::class), $class);
    }
...
{
    public function __construct(protected Router $router, protected \Illuminate\Foundation\Http\Kernel $kernel, protected string $middleware)
    {
        //
    }
